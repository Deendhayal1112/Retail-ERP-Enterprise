...
class KPIManager {
  constructor() {
    this.kpis = [
      { id: "rev", name: KPITypes.REVENUE, value: "₹1,24,500.00", status: "Positive", change: "+14.2%" },
      ...
      { id: "inv_val", name: KPITypes.INVENTORY_VALUE, value: "₹3,10,000.00", status: "Stable", change: "-2.4%" },
