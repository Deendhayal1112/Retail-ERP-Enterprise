/**
 * AdminGuidePanel.js
 * Retail ERP Enterprise — Administrator Guides & Policy Outlines
 */

"use strict";

export default class AdminGuidePanel {
  constructor(options = {}) {
  ...
  render() {
    ...
    card.innerHTML = `
      <h3 class="docs-center-card-title">Administrator Guides & Maintenance Playbooks</h3>
    ...
    this.guides.forEach(g => {
      ...
      row.querySelector(".view-guide-btn").addEventListener("click", () => {
        alert(`Opening "${g.title}" in secure HTML viewer mode...`);
      });
